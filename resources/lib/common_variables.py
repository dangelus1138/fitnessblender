...
#youtube
channel_id = "UCiP6wD_tYlYLYh3agzbByWQ"
youtube_api_key = "AIzaSyAAsgrIGx4e4AKN0FMp5orxfwjm55PL1js" #If you fork this addon please register another api key (https://developers.google.com/youtube/android/player/register)
#youtube channel
cast = ['Kelli','Daniel'] #Founders / Cast of the channel. [] if none
tvshowtitle = 'Fitness Blender' #Name of the show
status = 'Continuing' #Status of the show
episode_playlists = ['PL5lPziO_t_VgbyNGxl8d7Pio3tdwMXp-c']
episode_playlists = ['PL5lPziO_t_VgzkYXnOH3yCqFf8nGdMthk']
episode_playlists = ['PL5lPziO_t_VgdnI02Bi4XDlJTphcuX6dW']
 #List of playlists to consider every integer as the episode number
